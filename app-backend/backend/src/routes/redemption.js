 ...
 * Generate verification code for deal redemption (User claims deal)
 * Requires authentication
 */
router.post('/generate-code',
  authenticate,
  redemptionController.generateVerificationCode
);

/**
 * POST /api/v1/redemptions/verify-code
 * Verify code and complete redemption (Merchant verifies)
 * Requires authentication and restaurant owner role
 */
router.post('/verify-code',
  authenticate,
  authorize(['RESTAURANT_OWNER', 'ADMIN']),
  redemptionController.verifyAndCompleteRedemption
);
