  ...
  const [deals, setDeals] = useState([
    {
      ...
      franchise: "South Yardley Branch",
      restaurant: "Olive Garden",
      description: "2 Classic Beef Burgers + 1 Large Fries + 1 Coke (500ml)",
      price: "$15.99",
      originalPrice: "$24.99",
      discount: "36%",
      status: "pending",
    ...
    },
    {
      id: 2,
      title: "Pizza Combo",
      franchise: "Acocks Green Branch",
      restaurant: "Red Lobster",
      description: "1 Large Pepperoni Pizza + 1 Garlic Bread + 2 Drinks",
      price: "$19.99",
      originalPrice: "$29.99",
      discount: "33%",
      status: "active",
    ...
    },
    {
      ...
      franchise: "Boldmere Branch",
      restaurant: "Red Lobster",
      description: "Grilled Salmon + Shrimp Platter + Side Salad",
      price: "$24.99",
      originalPrice: "$34.99",
      discount: "29%",
      status: "active",
    ...
    },
    {
      id: 5,
      title: "Sushi Combo",
      franchise: "Quinton Branch",
      restaurant: "Benihana",
      description: "20 Pieces Mixed Sushi + Miso Soup + Green Tea",
      price: "$29.99",
      originalPrice: "$44.99",
      discount: "33%",
      status: "pending",
    ...
    },
    {
      id: 6,
      title: "Steak Night",
      franchise: "Doe Bank Branch",
      restaurant: "Texas Roadhouse",
      description: "12oz Ribeye Steak + Baked Potato + Vegetables",
      price: "$32.99",
      originalPrice: "$45.99",
      discount: "28%",
      status: "pending",
