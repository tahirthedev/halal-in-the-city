...
const Restaurants = () => {
  ...
  const restaurants = [
    {
      ...
      description: "Famous for crispy fried chicken and garlic sauce. Family-friendly restaurant with quick service.",
      image: img1,
      rating: 4.8,
      totalOrders: 2543,
      branches: [
        { id: 1, name: "Downtown", address: "King Fahd Road", status: "active" },
        { id: 2, name: "Mall Branch", address: "Red Sea Mall", status: "active" }
      ],
      status: "active",
    ...
    },
    {
      ...
      ownerName: "Omar Ali",
      email: "omar@shawarma.com",
      website: "www.shawarma-corner.com",
      phone: "+966 11 234 5678",
      description: "Authentic Lebanese shawarma with fresh ingredients and traditional spices.",
      image: img2,
      rating: 4.6,
      totalOrders: 1876,
      branches: [
        { id: 1, name: "City Center", address: "Olaya Street", status: "active" }
      ],
      status: "active",
    ...
    },
    {
      ...
      category: "Middle Eastern",
      ownerName: "Omar Ali",
      email: "omar@kebabjunction.com",
      website: "www.kebabjunction.com",
      phone: "+966 11 234 5678",
      description: "Authentic Lebanese kebabs with fresh ingredients and traditional spices.",
      image: img1,
      rating: 4.6,
      totalOrders: 1876,
      branches: [
    ...
    },
    {
      ...
      email: "tariq@biryani.com",
      website: "www.biryanipalace.com",
      phone: "+966 13 345 6789",
      description: "Premium Pakistani cuisine specializing in aromatic biryanis and traditional curries.",
      image: img3,
      rating: 4.7,
      totalOrders: 3421,
      branches: [
        { id: 1, name: "Main Branch", address: "Prince Faisal Street", status: "active" },
        { id: 2, name: "North Branch", address: "Al-Nakheel District", status: "pending" }
      ],
      status: "pending",
  ...
  const handleReject = (id) => {
    console.log("Reject restaurant:", id)
                    ...
                    <tbody>
                      {currentItems.map((restaurant) => (
                        <tr key={restaurant.id}>
                          ...
                          <td>
                            <span className="owner-name">{restaurant.ownerName}</span>
                          </td>
                          <td>
              ...
              <div className="restaurant-details">
                <div className="restaurant-header">
                  ...
                  <div className="restaurant-info-detailed">
                    ...
                    <p className="owner-info">Owned by {selectedRestaurant.ownerName}</p>
                  </div>
                </div>
                ...
                <div className="restaurant-stats-detailed">
                  ...
                  <div className="stat-card">
                    ...
                    <div className="stat-info">
                      <span className="stat-number">{selectedRestaurant.totalOrders}</span>
